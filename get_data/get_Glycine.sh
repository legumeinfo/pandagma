...
curl -O $url_base/max/annotations/Hwangkeum.gnm1.ann1.1G4F/glyma.Hwangkeum.gnm1.ann1.1G4F.cds.fna.gz
...
curl -O $url_base/max/annotations/Hwangkeum.gnm1.ann1.1G4F/glyma.Hwangkeum.gnm1.ann1.1G4F.cds.bed.gz
...
curl -O $url_base/max/annotations/Lee.gnm2.ann1.1FNT/glyma.Lee.gnm2.ann1.1FNT.cds.bed.gz
...
curl -O $url_base/max/annotations/Wm82_ISU01.gnm2.ann1.FGFB/glyma.Wm82_ISU01.gnm2.ann1.FGFB.cds.bed.gz
