...
#   medsa.XinJiangDaYe_hap1.gnm1.ann1.MS.gene87716.t1 --> medsa.XinJiangDaYe.gnm1.ann1.MS.gene87716.t1
#   medsa.XinJiangDaYe_hap2.gnm1.ann1.MS.gene27472.t1 --> medsa.XinJiangDaYe.gnm1.ann1.MS.gene27472.t1

# Call this from the main pandagma.sh directory, outside out_Medicago_7_16:
#   ./get_data/post_process_Medicago.sh

perl -pi -e 's/(medsa.XinJiangDaYe)_hap[^.]+/$1/g' out_Medicago_7_16/*pan*
